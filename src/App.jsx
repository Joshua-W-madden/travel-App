    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "700px", width: "900px", margin: "auto" }}>
      ...
      <div style={{ marginTop: "20px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
          <button onClick={() => setCatalogResult("Result 1")}>Option 1</button>
          <button onClick={() => setCatalogResult("Result 2")}>Option 2</button>
          <button onClick={() => setCatalogResult("Result 3")}>Option 3</button>
        </div>
